...
if (avilableLasers(2))
    ...
    laser473nm.posExtLens = [0.040030000000000,0.800140000000000];
    laser473nm.posDetLens = [0.00,0.00];
    laser473nm.symmetry = [81; 79.9]; 
    laser473nm.Delay = [11.86 25.4 39.52 75 84.6 118.01; 11.86 25.5 39.52 77.2 77.3 118.01];
...
if (avilableLasers(4))
    ...
    laser556nm.posExtLens = [0.020080000000000,0.600150000000000];
    laser556nm.posDetLens = [0.00, 0.00];
    laser556nm.symmetry = [77.5; 77.5]; %[92.4 92.4 91.4 91.3 91.5 91.4]
    laser556nm.Delay = [12.16 25.5 75 75 87.1 121.8; 12.16 25.4 75 75 87.1 121.8]; %ms
...
%Scan parameters:
binning = '2x2'; %Other options '2x2', '4x4', '8x8'
